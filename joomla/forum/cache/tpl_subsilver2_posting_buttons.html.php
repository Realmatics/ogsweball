...
<select name="syntaxbbcode" onchange="bbfontstyle('[codex=' + this.form.syntaxbbcode.options[this.form.syntaxbbcode.selectedIndex].value + ']', '[/codex]');this.form.syntaxbbcode.selectedIndex = 0;" title="<?php echo ((isset($this->_rootref['L_BBCODE_F_HELP'])) ? $this->_rootref['L_BBCODE_F_HELP'] : ((isset($user->lang['BBCODE_F_HELP'])) ? $user->lang['BBCODE_F_HELP'] : '{ BBCODE_F_HELP }')); ?>">
    	<option selected="selected">Syntax Highlighter</option>		
        <option value="coldfusion">Adobe ColdFusion</option>
        <option value="actionscript3">ActionScript 3.0</option>
		<option value="applescript">AppleScript</option>
		<option value="shell" >Bash</option>
		<option value="cpp">C o C++</option>
        <option value="c-sharp">C#</option>
        <option value="delphi">Delphi</option>
        <option value="diff">Diff</option>
        <option value="erlang">Erlang</option>
        <option value="css">Hojas de estilo en cascada</option>
        ...
        <option value="sass">Sintácticamente CSS impresionante</option>
