...
<!-- Please leave the copyright notice below intact, it's the only kind of attribution / payment we get for freely creating the style.
If you (honestly) can't keep it, we'd rather you didn't use the style. -->

<br />&copy; Absolution Style by OrbitStyles.com for <a href="http://www.phpbbcommunities.com" title="Free Forum Advertising">Free Forum Advertising</a></div></div>
...
<?php if ($this->_rootref['U_ACP']) {  ?><a href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ACP'])) ? $this->_rootref['L_ACP'] : ((isset($user->lang['ACP'])) ? $user->lang['ACP'] : '{ ACP }')); ?> &bull;</a><?php } ?>Powered by <a href="http://www.phpbb.com/">phpBB</a>&reg;
</div>
</div><!-- /float-right -->
</div><!-- /footer-toolbar-->
