...
<div class="my-box my-sheet"> 
  ...
  <div id="hoverlogo" class="logo" style="cursor:pointer;" onclick="location.href='/';" onmouseover="this.className='logohover';" onmouseout="this.className='logo';"></div>
  <div id="hovertellus" class="tellus" style="cursor:pointer;" onclick="location.href='/help/forum';" onmouseover="this.className='tellushover';" onmouseout="this.className='tellus';"></div>
...
<div class="cleared"></div>
<!--<div style="position: relative; left: 20px; top: 0px; width: 920px; height: 1px; background-color: #366092;"> </div>
<div style="position: relative; left: 10px; top: 0px; width: 957px; height: 138px;"><img src="images/alle_logos.png" border="0" title="logos" /></div>-->
...
<p class="my-page-footer"><?php echo "test";?></p>
    <div class="cleared"></div>
</div>
