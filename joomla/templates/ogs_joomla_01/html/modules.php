...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'my-nostyle';
  $styles = array(
    'my-nostyle' => 'modChrome_artnostyle',
    'my-block' => 'modChrome_artblock',
    'my-article' => 'modChrome_artarticle',
    'my-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'my-...'        - overwrites module style.
  //  'my-... suffix' - overwrites style and adds suffix to the module root tag and
  //                     to the module elements, does not add my-... to the module elements.
  $classes = '';
...
<div class="my-nostyle<?php echo $params->get('artx-module-classes'); ?>">
