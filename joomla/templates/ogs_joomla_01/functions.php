...
if (!defined('_ARTX_FUNCTIONS')) {
    ...
    function artxPost($data)
    {
    	...
    	artxFragmentBegin(str_replace('class="my-box my-post">', 'class="my-box my-post' . $classes . '">', "<div class=\"my-box my-post\">\r\n    <div class=\"my-box-body my-post-body\">\r\n<div class=\"my-post-inner\">\r\n"));
    	artxFragmentBegin("<h2 class=\"my-postheader\">");
    	artxFragmentBegin("");
...
?>
        <?php ob_start(); ?>
<div class="my-box my-block">
            <div class="my-box-body my-block-body">
        
        <?php echo str_replace('class="my-box my-block">', 'class="my-box my-block' . $classes . '">', ob_get_clean()); ?>
        <?php if ($hasCaption): ?>
<div class="my-bar my-blockheader">
            <h3 class="t">
        <?php echo $caption; ?>
</h3>
        </div>
        <?php endif; ?>
        <?php if ($hasContent): ?>
<div class="my-box my-blockcontent">
            <div class="my-box-body my-blockcontent-body">
...
<?php
    ...
    function artxModules(&$document, $position, $style = null)
    {
         ...
         *  Select inputs with class != 'my-button'
         *   artxFindTags($html, array('input' => array('class' => '!my-button')))
         *  Select inputs with non-empty class
         *   artxFindTags($html, array('input' => array('class' => '!')))
         *  Select inputs with class != 'my-button' and non-empty class:
         *   artxFindTags($html, array('input' => array('class' => array('!my-button', '!'))))
         *  Select inputs with class = button but != 'my-button'
         *   artxFindTags($html, array('input' => array('class' => array('button', '!my-button'))))
         *
        ...
        function artxReplaceButtons($content, $filter = array('input' => array('class' => 'button')))
        {
            ...
            foreach (artxFindTags($content, $filter) as $tag) {
                if (is_string($tag))
                    ...
                    $tag['attributes']['class']['value'][] = 'my-button';
                    $delimeter = '' == $tag['attributes']['class']['delimeter']
                        ? '"' : $tag['attributes']['class']['delimeter'];
                    $tag['attributes']['class']['delimeter'] = $delimeter;
                    $button = str_replace('"', $delimeter, '<span class="my-button-wrapper">'
                        . '<span class="my-button-l"> </span><span class="my-button-r"> </span>')
        ...
        {
            return '<span class="my-button-wrapper"><span class="my-button-l"> </span><span class="my-button-r"> </span>'
                . '<a class="' . (isset($data['classes']) && isset($data['classes']['a']) ? $data['classes']['a'] . ' ' : '')
                . 'my-button" href="' . $data['link'] . '">' . $data['content'] . '</a></span>';
        }
...
function artxPostprocessBlockContent($content)
    ...
    {
        $content = artxReplaceButtons($content, array('input' => array('class' => array('button', '!my-button')),
            'button' => array('class' => array('button', '!my-button'))));
        return $content;
    }
