...
if (GAnalyticsHelper::isPROMode()) {
	...
	$scriptCode .= "jQuery('#ga-browser-chart').gaChart({
	...
	$scriptCode .= "jQuery('#ga-browser-chart').gaChart('refresh');\n";

	$scriptCode .= "jQuery('#ga-country-chart').gaChart({
	...
	$scriptCode .= "jQuery('#ga-country-chart').gaChart('refresh');\n";
