...
$scriptCode = "jQuery(document).ready(function() {jQuery('#ga-date-chart').gaChart({
...
$scriptCode .= "jQuery('#ga-date-chart').gaChart('refresh');\n";

$scriptCode .= "jQuery('#ga-source-chart').gaChart({
...
$scriptCode .= "jQuery('#ga-source-chart').gaChart('refresh');\n";

$scriptCode .= "jQuery('#ga-mobile-chart').gaChart({
...
$scriptCode .= "jQuery('#ga-mobile-chart').gaChart('refresh');\n";

$scriptCode .= "jQuery('#ga-language-chart').gaChart({
...
$scriptCode .= "jQuery('#ga-language-chart').gaChart('refresh');\n";

$scriptCode .= "jQuery('#ga-referrer-chart').gaChart({
...
$scriptCode .= "jQuery('#ga-referrer-chart').gaChart('refresh');\n";
