...
class JFormFieldMetricsCombo extends JFormFieldGroupedList{
	...
	protected function getGroups(){
		...
		JFactory::getDocument()->addScript(JURI::base().'components/com_ganalytics/libraries/jquery/jquery.min.js');
		...
		JFactory::getDocument()->addScriptDeclaration("jQuery(document).ready(function(){createMultiSelectCombo(jQuery('#".$this->id."'));});");
